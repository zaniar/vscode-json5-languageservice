...
import { JSON55DocumentSymbols } from './services/json5DocumentSymbols';
import { parse as parseJSON5, newJSON55Document } from './parser/json5Parser';
import { schemaContributions } from './services/configuration';
import { JSON55SchemaService } from './services/json5SchemaService';
...
export function getLanguageService(params) {
    ...
    var jsonSchemaService = new JSON55SchemaService(params.schemaRequestService, params.workspaceContext, promise);
    ...
    var jsonDocumentSymbols = new JSON55DocumentSymbols(jsonSchemaService);
    ...
    return {
        ...
        parseJSON55Document: function (document) { return parseJSON5(document, { collectComments: true }); },
        newJSON55Document: function (root, diagnostics) { return newJSON55Document(root, diagnostics); },
