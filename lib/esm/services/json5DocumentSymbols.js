...
import { Range, TextEdit, SymbolKind, Location } from "../json5LanguageTypes";
var JSON55DocumentSymbols = /** @class */ (function () {
    function JSON55DocumentSymbols(schemaService) {
        this.schemaService = schemaService;
    }
    JSON55DocumentSymbols.prototype.findDocumentSymbols = function (document, doc, context) {
        var _this = this;
    ...
    JSON55DocumentSymbols.prototype.findDocumentSymbols2 = function (document, doc, context) {
        var _this = this;
        if (context === void 0) { context = { resultLimit: Number.MAX_VALUE }; }
        var root = doc.root;
        if (!root) {
    ...
    JSON55DocumentSymbols.prototype.getSymbolKind = function (nodeType) {
        switch (nodeType) {
            case 'object':
    ...
    JSON55DocumentSymbols.prototype.getKeyLabel = function (property) {
    ...
    JSON55DocumentSymbols.prototype.findDocumentColors = function (document, doc, context) {
    ...
    JSON55DocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
        var result = [];
    ...
    return JSON55DocumentSymbols;
}());
export { JSON55DocumentSymbols };
