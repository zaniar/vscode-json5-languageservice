...
import { MarkedString, TextDocument } from '../json5LanguageService';
suite('JSON5 Hover', function () {
    function testComputeInfo(value, schema, position) {
        var uri = 'test://test.json';
        var schemaService = new SchemaService.JSON5SchemaService(requestService);
        var hoverProvider = new JSON5Hover(schemaService, [], Promise);
