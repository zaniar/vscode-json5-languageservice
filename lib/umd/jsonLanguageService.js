...
(function (factory) {
    ...
    function getLanguageService(params) {
        ...
        var jsonSchemaService = new json5SchemaService_1.JSON5SchemaService(params.schemaRequestService, params.workspaceContext, promise);
        ...
        var jsonDocumentSymbols = new json5DocumentSymbols_1.JSON5DocumentSymbols(jsonSchemaService);
        ...
        return {
            ...
            parseJSON5Document: function (document) { return json5Parser_1.parse(document, { collectComments: true }); },
            newJSON5Document: function (root, diagnostics) { return json5Parser_1.newJSON5Document(root, diagnostics); },
