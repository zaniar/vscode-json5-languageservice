...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../json5LanguageService", "../utils/strings"], factory);
    }
    ...
    suite('JSON5 Completion', function () {
        var testCompletionsFor = function (value, schema, expected, clientCapabilities) {
            if (clientCapabilities === void 0) { clientCapabilities = json5LanguageService_1.ClientCapabilities.LATEST; }
            var offset = value.indexOf('|');
            value = value.substr(0, offset) + value.substr(offset + 1);
            var ls = json5LanguageService_1.getLanguageService({ clientCapabilities: clientCapabilities });
            if (schema) {
                ls.configure({
                    schemas: [{
