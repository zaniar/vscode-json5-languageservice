...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../parser/json5Parser", "../json5LanguageService"], factory);
    }
    ...
    suite('JSON5 Parser', function () {
        ...
        function toDocument(text) {
            var textDoc = json5LanguageService_1.TextDocument.create('foo://bar/file.json', 'json', 0, text);
            var ls = json5LanguageService_1.getLanguageService({});
            var jsonDoc = ls.parseJSON5Document(textDoc);
            return { textDoc: textDoc, jsonDoc: jsonDoc };
        }
        function toRange(text, offset, length) {
            var textDoc = json5LanguageService_1.TextDocument.create('foo://bar/file.json', 'json', 0, text);
            return json5LanguageService_1.Range.create(textDoc.positionAt(offset), textDoc.positionAt(offset + length));
        }
        ...
        test('Objects', function () {
            ...
            isInvalid('{3:3}');
            isInvalid('{\'key\': 3}');
            isInvalid('{"key" 3}', json5LanguageService_1.ErrorCode.ColonExpected);
            isInvalid('{"key":3 "key2": 4}', json5LanguageService_1.ErrorCode.CommaExpected);
            isInvalid('{"key":42, }', json5LanguageService_1.ErrorCode.TrailingComma);
            isInvalid('{"key:42', json5LanguageService_1.ErrorCode.UnexpectedEndOfString, json5LanguageService_1.ErrorCode.ColonExpected);
        });
        test('Arrays', function () {
            ...
            isInvalid('[');
            isInvalid('[,]', json5LanguageService_1.ErrorCode.ValueExpected);
            isInvalid('[1 2]', json5LanguageService_1.ErrorCode.CommaExpected);
            isInvalid('[true false]', json5LanguageService_1.ErrorCode.CommaExpected);
            isInvalid('[1, ]', json5LanguageService_1.ErrorCode.TrailingComma);
            isInvalid('[[]', json5LanguageService_1.ErrorCode.CommaOrCloseBacketExpected);
            isInvalid('["something"');
            isInvalid('[magic]');
        });
        test('Strings', function () {
            ...
            isInvalid('["\\u123Z"]');
            isInvalid('[\'string\']');
            isInvalid('"\tabc"', json5LanguageService_1.ErrorCode.InvalidCharacter);
        });
        ...
        test('Simple AST', function () {
            {
                ...
                assert.equal(node.type, 'object');
                assert.deepEqual(json5Parser_1.getNodePath(node), []);
            ...
            }
            {
                ...
                assert.deepEqual(json5Parser_1.getNodePath(node), [0]);
            }
            {
                ...
                assert.deepEqual(json5Parser_1.getNodePath(node), ['a']);
        ...
        test('Missing colon', function () {
            ...
            var jsonDoc = toDocument(content).jsonDoc;
            assert.equal(jsonDoc.syntaxErrors.length, 1);
            assert.equal(jsonDoc.syntaxErrors[0].code, json5LanguageService_1.ErrorCode.ColonExpected);
        ...
        test('Missing comma', function () {
            ...
            var jsonDoc = toDocument(content).jsonDoc;
            assert.equal(jsonDoc.syntaxErrors.length, 1);
            assert.equal(jsonDoc.syntaxErrors[0].code, json5LanguageService_1.ErrorCode.CommaExpected);
        ...
        test('const', function () {
            ...
            }
            {
                ...
                var semanticErrors = jsonDoc.validate(textDoc, schema);
                assert.strictEqual(semanticErrors.length, 1);
                assert.strictEqual(semanticErrors[0].code, json5LanguageService_1.ErrorCode.EnumValueMismatch);
            }
            {
                var schema_1 = {
                    properties: {
        ...
        test('Strings with spaces', function () {
            ...
            assert.strictEqual(json5Parser_1.getNodeValue(node), 'first string');
            node = jsonDoc.getNodeFromOffset(34);
            assert.strictEqual(json5Parser_1.getNodeValue(node), 'second string');
        });
        test('Schema information on node', function () {
            ...
            assert.strictEqual(json5Parser_1.getNodeValue(node), 42);
        ...
        test('parse with comments', function () {
            function parse(v) {
                ...
                assert.equal(jsonDoc.syntaxErrors.length, 0);
                return json5Parser_1.getNodeValue(jsonDoc.root);
            }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            ls = json5LanguageService_1.getLanguageService({});
