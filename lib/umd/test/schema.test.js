...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../services/json5SchemaService", "../parser/json5Parser", "fs", "url", "path", "../json5LanguageService"], factory);
    }
        ...
        test('Resolving $refs', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    service = new SchemaService.JSON55SchemaService(newMockRequestService(), workspaceContext);
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            ls = json5LanguageService_1.getLanguageService({ workspaceContext: workspaceContext, schemaRequestService: schemaRequestService });
