...
import { DefinitionLink, Position, TextDocument, ASTNode, PropertyASTNode, Range, Thenable } from '../json5LanguageTypes';
import { JSON5Document } from '../parser/json5Parser';

export function findDefinition(document: TextDocument, position: Position, doc: JSON5Document): Thenable<DefinitionLink[]> {
