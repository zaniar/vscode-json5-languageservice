...
export class JSON5DocumentSymbols {

	constructor(private schemaService: IJSON5SchemaService) {
	}

	public findDocumentSymbols(document: TextDocument, doc: Parser.JSON5Document, context: DocumentSymbolsContext = { resultLimit: Number.MAX_VALUE }): SymbolInformation[] {
	...
	public findDocumentSymbols2(document: TextDocument, doc: Parser.JSON5Document, context: DocumentSymbolsContext = { resultLimit: Number.MAX_VALUE }): DocumentSymbol[] {
	...
	public findDocumentColors(document: TextDocument, doc: Parser.JSON5Document, context?: DocumentSymbolsContext): Thenable<ColorInformation[]> {
	...
	public getColorPresentations(document: TextDocument, doc: Parser.JSON5Document, color: Color, range: Range): ColorPresentation[] {
